...
import { MAX_SOUND_BYTES, MAX_SOUND_SECONDS, MSG_TEST_REMINDER } from "../constants";
    ...
    <div className="grid gap-3">
      <Card className="tape">
        <CardContent className="flex items-center justify-between gap-4 p-4">
          <div className="grid gap-1">
            <Label htmlFor="enabled" className="text-sm font-bold">
              Reminders on
            </Label>
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="marker-underline marker-teal inline-block text-base">
            Schedule
          </CardTitle>
        </CardHeader>
